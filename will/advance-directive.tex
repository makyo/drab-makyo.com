...
Grantor: \emph{Madison Scott-Clary}
...
\begin{quote}
    I certify that I know or have satisfactory evidence that the GRANTOR, \emph{Madison Scott-Clary} signed this instrument and acknowledged it to be her free and voluntary act for the uses and purposes mentioned in the instrument.
\end{quote}
...
\subsection{Health Care Directive}\label{health-care-directive}
